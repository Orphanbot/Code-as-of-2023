...
@TeleOp(name="Holicron 1PN", group="Linear Opmode")
//@Disabled
public class NEWHolicronBot_1P extends LinearOpMode {

    NEWHolicronHardware robot           = new NEWHolicronHardware();
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.b) {
                robot.clawR.setPosition(0.31);
                robot.clawL.setPosition(0.46);
            }
            if (gamepad1.a) {
                robot.clawR.setPosition(0.55);
                robot.clawL.setPosition(0.70);
            }
...
//right claw close: 0.42; open: 0.18
//left claw close: 0.62; open: 0.38

//new right close: 0.55; open: 0.31
//new left close: 0.70; open: 0.46
